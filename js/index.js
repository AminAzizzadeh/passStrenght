...
const result = document.querySelector(".passStrenght");
let finalResult = 0;
let trues = 0;
...
function changeClass() {
    result.classList.remove("red", "orange", "yellow", "green");
}
...
pass.addEventListener("input", function () {
    ...
    if (trues >= 1 || lenghtTrue == true) {
        ...
        document.getElementById("widthchanger").style.width = finalResult + "%";
        ...
        else if (finalResult >= 15 && finalResult <= 35) {
            changeClass();
            result.classList.add("red");
        }
        else if (finalResult > 35 && finalResult <= 60) {
            changeClass();
